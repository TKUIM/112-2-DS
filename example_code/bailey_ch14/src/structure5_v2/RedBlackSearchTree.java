...
*     
* > java RedBlackSearchTree
Did we work: true	 Size: 0	0
Did we work: true	 Size: 1	0
Did we work: true	 Size: 2	0
Did we work: true	 Size: 3	0
Did we work: true	 Size: 4	0
Did we work: true	 Size: 5	0
Did we work: true	 Size: 6	0
Did we work: true	 Size: 7	0
Did we work: true	 Size: 8	0
Did we work: true	 Size: 9	0
Did we work: true	 Size: 10	0
.....
Did we work: true	 Size: 4991	0
Did we work: true	 Size: 4992	0
Did we work: true	 Size: 4993	0
Did we work: true	 Size: 4994	0
Did we work: true	 Size: 4995	0
Did we work: true	 Size: 4996	0
Did we work: true	 Size: 4997	0
Did we work: true	 Size: 4998	0
Did we work: true	 Size: 4999	0
*/
// This is an implementation of binary search trees.
// (c) 1998, 2001 duane a. bailey
package structure5_v2;
...
public class RedBlackSearchTree<E extends Comparable<E>> extends AbstractStructure<E> implements OrderedStructure<E>
{
    ...
    public static void test1(int size){
        RedBlackSearchTree<Long> test = new RedBlackSearchTree<>();
        Long r = new Long(1);
        ...
        int j=0;
        for(Iterator<Long> i = test.iterator(); i.hasNext();){
            store[j++] = i.next();
        }
